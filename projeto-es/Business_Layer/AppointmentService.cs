...
namespace projeto_es.Models
{
    class AppointmentService
    {
        ...
        public List<Appointment> GetsAppointmentsOfAClient(int ClientId)
        {
            string GetAppointmentsOfAClient = $"SELECT * " +
                "FROM appointment, clientaccount " +
                "WHERE appointment.ClientAccount_id = clientaccount.id" +
